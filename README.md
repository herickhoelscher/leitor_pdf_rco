...
1. Clique em **Escolher Pasta** para selecionar uma pasta com PDFs do RCO  
   — ou **Escolher Arquivos** para selecionar arquivos individuais
2. Clique em **▶ Processar PDFs**
3. Aguarde o processamento (barra de progresso)
4. Use **Exportar Excel (.xlsx)** para gerar o arquivo completo  
   — ou **Exportar CSV** para usar diretamente no Power BI
